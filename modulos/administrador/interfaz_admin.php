...
<script type="text/javascript" src="js/interfazAdmin.js"></script> 
<style type="text/css">
...
<div>
		...
		<p><CENTER> <img src="<?php echo $imageempresa; ?>" height="69"><br><FONT STYLE="color:#0000FF;font-size:24px;"><B>ADMINISTRACION DE LOS USUARIOS DEL SISTEMA</B></FONT></CENTER></p>
		<br><!--espacios  -->
