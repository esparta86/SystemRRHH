...
<script type="text/javascript" src="js/interfazFormCompetenciasxcargo.js"></script> 
...
<div>
		...
		<p><CENTER> <img src="<?php echo $imageempresa; ?>" height="69"> <br><FONT STYLE="color:#0000FF;font-size:24px;"><B>FORMULARIO DE CARGOS DE : <?php echo $nombreEmpresa?></B></FONT></CENTER></p>
		<br><!--espacios  -->
