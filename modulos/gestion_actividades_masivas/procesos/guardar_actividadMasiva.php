    ...
    if($objactividadesMasivas!=null){
			    	 if(!$objactividadesMasivas->open_con())
			    {
			    ...
			    else if ($objactividadesMasivas->open_con()) 
							{
							    ...
							    $estado=$objactividadesMasivas->guardar_actividadMasiva($competencias,$id_actividad,$id_especializacion,$id_tema,$t_tema,$t_area_en,$FRevision,$FPInicio,$FPFinal,$FRInicio,$FRFinal,$inicio,$final,$coment,$idReponsable);     
						    	
						    	if($estado){
						    		$data1[] = array('bandera'=>1,'msg'=>'Exito, Nueva Actividad agregada.');  
