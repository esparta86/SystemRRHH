...
<script type="text/javascript" src="js/interfazG_empleadoEV.js"></script> 
<style type="text/css">
...
<div>
		<p><CENTER> <img src="<?php echo $imageempresa; ?>" height="69"> <br><FONT STYLE="color:#0000FF;font-size:24px;"><B>GESTION DE EMPLEADOS  DE : <?php echo $nombreEmpresa?></B></FONT></CENTER></p>
		<br>
</div>
<br>
