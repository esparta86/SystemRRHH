...
<html>
<head>
<title>Grupos ocupacionales</title>
...
<script type="text/javascript" src="js/interfazGO.js"></script> 

<style type="text/css">


.icon-group {
background-image: url('../../recursos/img/group.png');
...
<div>
		...
		<p><CENTER> <img src="<?php echo $imageempresa; ?>" height="69"> <br><FONT STYLE="color:#0000FF;font-size:24px;"><B>GESTION DE GRUPOS OCUPACIONALES DE: <?php echo $nombreEmpresa?> </B></FONT></CENTER></p>
		<br><!--espacios  -->
...
<br>
	<center><div id="interfazGestionGO">
