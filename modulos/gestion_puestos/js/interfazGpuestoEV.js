...
var storeCargosEV=Ext.create('Ext.data.JsonStore',{
      model:'cargosEV',
      //pageSize:5,
       //remoteSort:true,
        ...
        buttons:[
        {
            ...
            handler: function(){
                ...
                if(this.up('form').getForm().isValid()){
                        ...
                        var post_idgrupo=Ext.getCmp('idgrupoo').getValue();
                        ...
                        if(accion!=0){//ingresar nueva competencia
                                ...
                                Ext.Ajax.request({
                                    url:'procesos/guardar_cargoEV.php?puesto='+post_nombrepuesto+'&jerarquia='+post_jerarquia+'&id_dpto='+post_iddpto+'&idgrupoo='+post_idgrupo,
                                    method:'POST',
                               ...
                               Ext.Ajax.request({
                                    url:'procesos/update_cargoEV.php?puesto='+post_nombrepuesto+'&jerarquia='+post_jerarquia+'&id_dpto='+post_iddpto+'&idgrupoo='+post_idgrupo+'&idcargo='+post_id_cargo,
                                    method:'POST',
