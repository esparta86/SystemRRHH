...
<script type="text/javascript" src="js/interfaztalento.js"></script>
...
<div>
		...
		<p><CENTER> <img src="<?php echo $imageempresa; ?>" height="69"> <br><FONT STYLE="color:#0000FF;font-size:24px;"><B> <?php /*echo $nombreProceso; */?> FORMULARIO DE TALENTO DE EMPLEADO, GESTION POR COMPETENCIAS DE: <?php echo $nombreEmpresa?></B></FONT></CENTER></p>
		<br><!--espacios  -->
