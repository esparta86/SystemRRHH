    ...
    if($objactividades!=null){//si se creo el objeto
			    	 if(!$objactividades->open_con())
			    {
			    ...
			    else if ($objactividades->open_con()) 
							{
							    ...
							    $estado=$objactividades->guardar_actividad($opcion,$codigoempleado,$id_actividad,$id_especializacion,$id_tema,$t_tema,$t_area_en,$FRevision,$FPInicio,$FPFinal,$FRInicio,$FRFinal,$inicio,$final,$coment,$idReponsable);     
